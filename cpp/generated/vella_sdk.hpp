...
class NativeVellaSdk : public jsi::HostObject {
private:
...
protected:
  ...
  jsi::Value cpp_uniffi_vella_sdk_fn_constructor_customtokenizerinner_new(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_vella_sdk_fn_method_customtokenizerinner_decode(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  ...
  jsi::Value cpp_uniffi_vella_sdk_fn_func_escape_text(jsi::Runtime &rt,
                                                      ...
                                                      size_t count);
  jsi::Value cpp_uniffi_vella_sdk_fn_func_parse_batch_response(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_vella_sdk_fn_func_parse_email(jsi::Runtime &rt,
                                                      const jsi::Value &thisVal,
                                                      const jsi::Value *args,
                                                      size_t count);
  jsi::Value cpp_uniffi_vella_sdk_fn_func_parse_visible_html(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  ...
  jsi::Value cpp_uniffi_vella_sdk_checksum_func_escape_text(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_vella_sdk_checksum_func_parse_batch_response(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_vella_sdk_checksum_func_parse_email(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_vella_sdk_checksum_func_parse_visible_html(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_vella_sdk_checksum_func_parse_visible_text(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
  jsi::Value cpp_uniffi_vella_sdk_checksum_method_customtokenizerinner_decode(
      jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
      size_t count);
...
public:
  NativeVellaSdk(
      jsi::Runtime &rt,
      std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker);
  virtual ~NativeVellaSdk();

  /**
   * The entry point into the crate.
   *
   * React Native must call `NativeVellaSdk.registerModule(rt, callInvoker)`
   ...
   * be the case.
   *
   * Clients should call `NativeVellaSdk.unregisterModule(rt)` after final use
   * where possible.
   */
