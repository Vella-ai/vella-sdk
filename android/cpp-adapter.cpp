...
// Automated testing checks Java_com_vellasdk_VellaSdkModule and vellasdk
...
// Installer coming from VellaSdkModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_vellasdk_VellaSdkModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return vellasdk::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_vellasdk_VellaSdkModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return vellasdk::cleanupRustCrate(*runtime);
}