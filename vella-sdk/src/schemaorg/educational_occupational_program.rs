...
pub struct EducationalOccupationalProgram {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub educational_credential_awarded:
        Vec<EducationalOccupationalProgramEducationalCredentialAwardedFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub program_prerequisites: Vec<EducationalOccupationalProgramProgramPrerequisitesFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub occupational_category: Vec<EducationalOccupationalProgramOccupationalCategoryFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub financial_aid_eligible: Vec<EducationalOccupationalProgramFinancialAidEligibleFieldEnum>,
    ///<https://schema.org/startDate>
    ...
    pub occupational_credential_awarded:
        Vec<EducationalOccupationalProgramOccupationalCredentialAwardedFieldEnum>,
    ///<https://schema.org/educationalProgramMode>
    #[serde(rename = "educationalProgramMode")]
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub educational_program_mode:
        Vec<EducationalOccupationalProgramEducationalProgramModeFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub typical_credits_per_term: Vec<EducationalOccupationalProgramTypicalCreditsPerTermFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub application_deadline: Vec<EducationalOccupationalProgramApplicationDeadlineFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub main_entity_of_page: Vec<EducationalOccupationalProgramMainEntityOfPageFieldEnum>,
    ///<https://schema.org/url>
    #[serde(rename = "url")]
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
