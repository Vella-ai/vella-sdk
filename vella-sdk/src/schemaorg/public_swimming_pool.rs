...
pub struct PublicSwimmingPool {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub diversity_staffing_report: Vec<PublicSwimmingPoolDiversityStaffingReportFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub actionable_feedback_policy: Vec<PublicSwimmingPoolActionableFeedbackPolicyFieldEnum>,
