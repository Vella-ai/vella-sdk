...
pub struct OfficeEquipmentStore {
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub diversity_staffing_report: Vec<OfficeEquipmentStoreDiversityStaffingReportFieldEnum>,
    ...
    #[serde_as(as = "OneOrMany<_>")]
    #[serde(default)]
    pub actionable_feedback_policy: Vec<OfficeEquipmentStoreActionableFeedbackPolicyFieldEnum>,
